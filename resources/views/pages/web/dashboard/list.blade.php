    ...
    <div class="d-flex flex-row-start">
        <div class="col-md-6">
            <div class="card-header">
                <h3 class="card-title">
                    <span class="text-muted font-weight-bold">{{ __('Menu Makanan') }}</span>
                </h3>
            </div>
            <div class="card-body">
                    ...
                    @if ($value->category_id == 2 && $value->created_at->diffInDays(Carbon\Carbon::now()) <= 1)
                        <div class="card card-flush shadow-sm">
                            ...
                            <div class="card-footer">
                                <p>
                                    <a href="javascript:;" onclick="load_detail('{{route('web.dashboard.show',$value->id)}}');" class="menu-link px-3"><i class="fa fa-eye text-primary"></i>View</a>
                                </p>
                            </div>
                        </div>
                        <hr class="my-4">
